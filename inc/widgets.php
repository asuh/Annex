...
class Twenty_Eleven_Ephemera_Widget extends WP_Widget {
	...
	function Twenty_Eleven_Ephemera_Widget() {
		$widget_ops = array( 'classname' => 'widget_annex_ephemera', 'description' => __( 'Use this widget to list your recent Aside, Status, Quote, and Link posts', 'annex' ) );
		$this->WP_Widget( 'widget_annex_ephemera', __( 'Twenty Eleven Ephemera', 'annex' ), $widget_ops );
		$this->alt_option_name = 'widget_annex_ephemera';
	...
	function widget( $args, $instance ) {
		$cache = wp_cache_get( 'widget_annex_ephemera', 'widget' );
		...
		$title = apply_filters( 'widget_title', empty( $instance['title'] ) ? __( 'Ephemera', 'annex' ) : $instance['title'], $instance, $this->id_base);
		...
		wp_cache_set( 'widget_annex_ephemera', $cache, 'widget' );
	}
	...
	function update( $new_instance, $old_instance ) {
		...
		if ( isset( $alloptions['widget_annex_ephemera'] ) )
			delete_option( 'widget_annex_ephemera' );

		return $instance;
	}

	function flush_widget_cache() {
		wp_cache_delete( 'widget_annex_ephemera', 'widget' );
	}
...
?>
			<p><label for="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>"><?php _e( 'Title:', 'annex' ); ?></label>
			<input class="widefat" id="<?php echo esc_attr( $this->get_field_id( 'title' ) ); ?>" name="<?php echo esc_attr( $this->get_field_name( 'title' ) ); ?>" type="text" value="<?php echo esc_attr( $title ); ?>" /></p>

			<p><label for="<?php echo esc_attr( $this->get_field_id( 'number' ) ); ?>"><?php _e( 'Number of posts to show:', 'annex' ); ?></label>
